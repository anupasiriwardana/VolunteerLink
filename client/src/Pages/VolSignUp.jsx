    ...
    <div className='min-h-screen mt-20 '>
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-10">
        ...
        <div className='flex-1'>
          <Link to="/" className=' text-4xl font-bold dark:text-white' onChange={handleChange}>
          <div className='flex'>
          ...
          <p className="mt-5 text-xl text-start">
            ...
            the right volunteer opportunities that match your skills
            and desires.
          </p>
        </div>
        ...
        <div className='flex-1'>
          <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            ...
            <Button className="bg-green-500 mt-5" type='submit' disabled={loading}>
              {
                loading ? (
                  <>
                    <Spinner size='sm'/>
